          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-[10px]">
              {[
                ...
                { Icon: MessageCircle, link: 'https://wa.me/919924058659' }
              ].map(({ Icon, link }, i) => (
                <a 
                  key={i} 
                  href={link}
                  target="_blank"
                  rel="noreferrer" 
                  className="w-11 h-11 flex items-center justify-center bg-white/[0.05] border border-white/10 rounded-[11px] text-white/60 hover:border-[#FF6A00] hover:text-[#FF6A00] hover:bg-[#FF6A0014] transition-all duration-[0.25s]"
                >
                  <Icon size={18} />
                </a>
              ))}
